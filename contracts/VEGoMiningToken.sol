...
contract VEGoMiningToken is IVEGoMiningToken, PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _token, string memory _name, string memory _symbol, string memory _version) initializer public {
        ...
        require(_token != address(0), "ve: _token is zero address");
        ...
        require(_decimals <= 255, "ve: decimals exceed 255");
