...
contract MinterBurner is PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _token, address _mintReward) initializer public {
        __Pausable_init();
        ...
        require(_mintReward != address(0), "_token is zero address");
        ...
        _grantRole(MINTER_AND_BURNER_ROLE, _msgSender());
        _grantRole(UPGRADER_ROLE, _msgSender());
        _grantRole(CONFIGURATOR_ROLE, _msgSender());
        _grantRole(TOKEN_OWNER_ROLE, _msgSender());
