...
contract MintReward is IMintReward, PausableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    function initialize(address _token, address _veToken) initializer public {
        __Pausable_init();
        ...
        rewards[0] = Reward(0, block.timestamp, block.number);
        rewardCount++;
